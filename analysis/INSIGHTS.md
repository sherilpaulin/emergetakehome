...
## I-017: The coach-calls/study-hall gap in I-014 was a tenure artifact, not a support effect -- it reverses once corrected

Coach calls and study hall sessions are cumulative counts, so anyone who stayed in the program longer has more chances to rack them up regardless of whether either one helps. Passed students have been in the program 127.3 days on average vs. 99.2 for stopped students (excluding never-started) -- 28 days longer, which alone would inflate their raw totals. Correcting for this with a rate-per-month-in-program: passed students average 0.488 coach calls/month and 0.312 study hall sessions/month; stopped students (who started but didn't finish) average **0.679 and 0.419** -- higher on both, not lower. **The raw-count gap in I-014 reverses once tenure is controlled for.** Don't read "more coach calls/study hall" as a lever for finishing on this evidence.

`joined_group_chat` is the one signal from I-014 that survives this test: it's a one-time join decision, not a cumulative count, so tenure can't mechanically inflate it, and excluding never-started students barely moves it (50.7% vs 32.4%, was 50.7% vs 32.5%). Still correlational (self-selected motivation could drive both joining and finishing) -- but it's the only one of the three support signals not explained away by time-in-program. **Source:** `analysis/finish_vs_stop_comparison.py`.
